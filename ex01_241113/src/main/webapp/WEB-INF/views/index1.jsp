...
<style>
    ...
    .container {
        display: flex;
        flex-direction: row; /* 세로가 아닌 가로로 정렬 */
        justify-content: space-between; /* 두 섹션 간 간격 */
        margin: 20px;
    }

    /* 왼쪽과 오른쪽 섹션 스타일 */
    .left-section, .right-section {
        width: 48%; /* 두 섹션의 너비를 48%로 설정 */
    ...
    /* 미디어 쿼리 - 모바일 화면에서 세로 레이아웃으로 변경 */
    @media (max-width: 768px) {
        .container {
            flex-direction: column; /* 모바일에서는 세로로 배치 */
        }
        .left-section, .right-section {
            width: 100%; /* 모바일에서는 각 섹션의 너비를 100%로 */
            margin-bottom: 20px;
        }
    }
</style>
